      ...
      <section className="container">
        <div className="split">
          <div>
            ...
            <h3 style={{ borderTop: "1px solid #CACACA" }}>
              Things to keep in mind
            </h3>
            <h4 className="my-3">
              <img className="border p-3" src={childs} alt="" /> Suitable for
            ...
            <h4 className="my-3">
              <img className="border p-3" src={forbidden} alt="" /> No parties
              or events
            </h4>
            <h4 className="my-3">
              <img className="border p-3" src={smoking} alt="" /> Smoking
              allowed
            </h4>
